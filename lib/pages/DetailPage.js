      ...
      <View style={styles.container}>
        <View>
          <View style={styles.imageB}>
            <Image style={styles.image} source={{uri: images.thumbnail}} />
          </View>
          <CardsComponent game={images} />

          <Text style={styles.subtitle}>Description:</Text>
          <Text style={styles.description}>{images.description}</Text>
          <Text style={styles.subtitle}>Screenshots:</Text>
          <CarouselComponentDetail images={images.screenshots} />
        </View>
      </View>
    </ScrollView>
  );
